...
public class program4 {
	 ...
	 * @param accidents
	 */
	public program4(ArrayDeque<Report> accidents) {
		days = new ArrayList<>();
...
//	}
	...
	// private int simulateDay(ArrayDeque<Report> queue, int counterNumber) { // Charles
...
//	}
	...
	public static void main(String args[]) throws FileNotFoundException, IOException {
		...
		Iterator<String[]> iter = new CSVFileIterator(args[0]);
		while (iter.hasNext()) {
